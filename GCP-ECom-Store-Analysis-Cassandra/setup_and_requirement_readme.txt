...
2.) Create Pub-Sub topics named as orders_data and payments_data with default subscribers
...
7.) Create keys for this newly create service account, json file will get download. Copy the content of that json file and replace it under /Users/lavanya.e/.config/gcloud/application_default_credentials.json
